...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('financials_marketdatapoint', 'High', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'MarketDataPoint.Low'
        db.alter_column('financials_marketdatapoint', 'Low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'MarketDataPoint.Change'
        db.alter_column('financials_marketdatapoint', 'Change', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        'financials.marketdatapoint': {
            ...
            'Change': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
